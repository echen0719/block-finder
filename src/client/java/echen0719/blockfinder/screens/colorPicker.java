...
public class colorPicker extends AbstractWidget {
    ...
    public void createInputs() {
        redBox = guiUtils.createInputBox(parent, this.getX(), this.getY(), this.width, 20, "0-255");
        greenBox = guiUtils.createInputBox(parent, this.getX(), this.getY() + 30, this.width, 20, "0-255");
        blueBox = guiUtils.createInputBox(parent, this.getX(), this.getY() + 60, this.width, 20, "0-255");
        alphaBox = guiUtils.createInputBox(parent, this.getX(), this.getY() + 90, this.width, 20, "0-1");
    }
